...
fecho ""
	...
	# Generate a random unique client name
...
# Define the dedicated folder
dedicatedFolder="/public"
...
# Now you can save the client configuration file in the homeDir
echo "Client configuration will be written to $homeDir"
